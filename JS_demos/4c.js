...
const displacementMapEarth = new THREE.TextureLoader().load('textures/earth_displacement.jpg');
const materialMap = new THREE.MeshPhongMaterial({ map: textureEarth, displacementMap: displacementMapEarth, displacementScale: 0.3 })

textureEarth.colorSpace = THREE.SRGBColorSpace;

// Creating spheres
const sphereGeometry = new THREE.SphereGeometry(2, 512, 512); // radius, widthSegments, heightSegments
